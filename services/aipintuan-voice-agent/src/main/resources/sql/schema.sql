-- ============================================================================
-- aipintuan-voice-agent 完整数据库 Schema
-- 目标：PostgreSQL 15+
-- 覆盖：商家、商品、画像、会话、订单
--
-- 使用：
--   createdb aipintuan_voice_agent
--   psql -d aipintuan_voice_agent -f schema.sql
--   psql -d aipintuan_voice_agent -f data.sql   # 导入测试数据
-- ============================================================================
