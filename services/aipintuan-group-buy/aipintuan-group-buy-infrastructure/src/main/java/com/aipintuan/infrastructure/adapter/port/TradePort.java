package com.aipintuan.infrastructure.adapter.port;

import com.aipintuan.domain.trade.adapter.port.ITradePort;
import com.aipintuan.domain.trade.model.entity.NotifyTaskEntity;
import com.aipintuan.domain.trade.model.valobj.NotifyTypeEnumVO;
import com.aipintuan.infrastructure.event.EventPublisher;
import com.aipintuan.infrastructure.gateway.GroupBuyNotifyService;
import com.aipintuan.infrastructure.redis.IRedisService;
import com.aipintuan.types.enums.NotifyTaskHTTPEnumVO;
...
public class TradePort implements ITradePort {
    ...
    public String groupBuyNotify(NotifyTaskEntity notifyTask) throws Exception {
        ...
        try {
            // aipintuan-group-buy 拼团服务端会被部署到多台应用服务器上，那么就会有很多任务一起执行。这个时候要进行抢占，避免被多次执行
