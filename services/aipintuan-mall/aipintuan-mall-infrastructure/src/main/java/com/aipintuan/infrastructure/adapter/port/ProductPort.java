...
import com.aipintuan.domain.order.adapter.port.IProductPort;
...
import com.aipintuan.infrastructure.gateway.ProductRPC;
import com.aipintuan.infrastructure.gateway.dto.*;
import com.aipintuan.infrastructure.gateway.response.Response;
...
public class ProductPort implements IProductPort {
    ...
    @Value("${aipintuan.integration.group-buy.source}")
    private String source;
    @Value("${aipintuan.integration.group-buy.chanel}")
    private String chanel;
    @Value("${aipintuan.integration.group-buy.notify-url}")
